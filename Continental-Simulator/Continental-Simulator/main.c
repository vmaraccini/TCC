...
int main(int argc, const char * argv[]) {
    ...
    CAN_ARS308_TARGET_1 *target2Objects[2] = {&vehicle1_t1, &vehicle2_t1};
    
    JSONArrayWithTarget1Objects(buffer, target1Objects, 2);
    printf(buffer);
    
    printf("\n\n");
    
    JSONArrayWithTarget2Objects(buffer, target2Objects, 2);
    printf(buffer);
}
