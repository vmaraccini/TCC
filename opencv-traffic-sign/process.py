...
# # Test functions
# image = cv2.imread("./signs/speed_limit_sign_17.png")
# segmented = segmentImageByTrafficSignColor(image)
# morphed = applyMorphologicalCorrections(segmented)
#
# cv2.imshow("segmented", cv2.pyrDown(segmented))
# cv2.imshow("morphed", cv2.pyrDown(morphed))
# cv2.waitKey(10000)
