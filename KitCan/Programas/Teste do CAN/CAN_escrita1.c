...
void configuracao ()
{
  ...
  // Configuração dos modos de sincronismo
   ...
   write (0x2B, 0x10); //  interrupções

   // Modo de funcionamento normal
   write (0x2C, 0x00); // Zera as interrupções e libera a mensagem para ser enviada
...
void main ()
{
   ...
   delay_ms (100);
       ...
       write (0x56, 0x01); // Endereço onde a mesagem será guardada
		 write (0x50, 0b00001011); // Instrução para enviar a mensagem
       ...
       write (0x52, 0x40); // ID da mensagem
       write (0x55, 0x01); // Define o DLC para 1 byte (tamanho do dado enviado)
       write (0x56, 0x04); // Endereço onde a mesagem será guardada
		 write (0x50, 0b00001011); // Instrução para enviar a mensagem
       write (0x50, 0b00000011);
		 write (0x2C , 0x00);
       delay_ms (2);
       ...
       write (0x52, 0x40); // ID da mensagem
       write (0x55, 0x01); // Define o DLC para 1 byte (tamanho do dado enviado)
       write (0x56, 0x10); // Endereço onde a mesagem será guardada
		 write (0x50, 0b00001011); // Instrução para enviar a mensagem
       write (0x50, 0b00000011);
		 write (0x2C , 0x00);
       delay_ms (2);
       ...
       write (0x52, 0x40); // ID da mensagem
       write (0x55, 0x01); // Define o DLC para 1 byte (tamanho do dado enviado)
       write (0x56, 0x40); // Endereço onde a mesagem será guardada
		 write (0x50, 0b00001011); // Instrução para enviar a mensagem
       write (0x50, 0b00000011);
		 write (0x2C , 0x00);
       delay_ms (2);
       ...
       write (0x52, 0x40); // ID da mensagem
       write (0x55, 0x01); // Define o DLC para 1 byte (tamanho do dado enviado)
       write (0x56, 0x03); // Endereço onde a mesagem será guardada
		 write (0x50, 0b00001011); // Instrução para enviar a mensagem
       write (0x50, 0b00000011);
		 write (0x2C , 0x00);
       delay_ms (2);
       ...
       write (0x52, 0x40); // ID da mensagem
       write (0x55, 0x01); // Define o DLC para 1 byte (tamanho do dado enviado)
       write (0x56, 0xFF); // Endereço onde a mesagem será guardada
		 write (0x50, 0b00001011); // Instrução para enviar a mensagem
       write (0x50, 0b00000011);
		 write (0x2C , 0x00);
       delay_ms (2);
